...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)GetNoteNameWithNote:(NSInteger)note;
...
- (void)receivedMIDINoteOffWithNoteNumber:(NSInteger)noteNumber velocity:(NSInteger)velocity channel:(NSInteger)channel;
- (void)receivedMIDIControllerWithController:(NSInteger)controller value:(NSInteger)value channel:(NSInteger)channel;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect SWIFT_UNAVAILABLE;
@end
...
*/
+ (NSView * _Nonnull)createViewWithWidth:(CGFloat)width height:(CGFloat)height;
@end
...
- (void)setup;
- (void)drawRect:(NSRect)dirtyRect;
- (NSTextField * _Nonnull)addTitle:(NSString * _Nonnull)text;
- (AKLabel * _Nonnull)addLabel:(NSString * _Nonnull)text;
- (void)addSubview:(NSView * _Nonnull)view;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface AKTelephoneView : NSView
- (void)mouseDown:(NSEvent * _Nonnull)theEvent;
